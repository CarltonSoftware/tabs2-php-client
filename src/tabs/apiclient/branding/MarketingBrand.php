 ...
 * @method \tabs\apiclient\branding\BookingBrand getDefaultbookingbrand() Returns the defaultbookingbrand
 */
class MarketingBrand extends Builder
{
     ...
     * Defaultbookingbrand
     *
     * @var \tabs\apiclient\branding\BookingBrand
     */
     ...
     * Set the agency
     *
     * @param array|\tabs\apiclient\actor\Agency $agency The Agency
     *
     ...
     *
     * @param array|\tabs\apiclient\branding\BookingBrand $defaultbookingbrand The Defaultbookingbrand
     *
     * @return MarketingBrand
     */
    public function setDefaultbookingbrand($defaultbookingbrand)
    {
        $this->defaultbookingbrand = \tabs\apiclient\branding\BookingBrand::factory(
            $defaultbookingbrand
        );
