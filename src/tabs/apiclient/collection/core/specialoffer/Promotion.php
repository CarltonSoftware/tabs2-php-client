 ...
 * @link      http://www.carltonsoftware.co.uk
 */
class Promotion extends \tabs\apiclient\collection\Collection
{
    /**
     * Return an array of Promotion objects.  This object will need to be
    ...
    {
        return $this->getParent()->getUpdateUrl() . '/promotion';
    }
