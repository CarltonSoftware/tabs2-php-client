 ...
 * @link      http://www.carltonsoftware.co.uk
 */
class Contact extends \tabs\apiclient\collection\Collection
{
    /**
     * Return an array of actor Contact objects.  This object will need to be
    ...
    {
        return $this->getElementParent()->getUpdateUrl() . '/contact';
    }
