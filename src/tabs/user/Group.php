 ...
 * 
 * @method \tabs\user\Group setId(integer $id)     Set the group Id
 * @method \tabs\user\Group setName(string $route) Set the group name
 */
class Group extends \tabs\core\Builder
{
    /**
     * Id
     * 
